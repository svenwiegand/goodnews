...
public class NotificationCompat {
    ...
    static class NotificationCompatImplJellyBean implements NotificationCompatImpl {
        public Notification getNotification(Builder b) {
            return NotificationCompatJellyBean.add(b.mContext, b.mNotification,
                    b.mContentTitle, b.mContentText, b.mContentInfo, b.mTickerView,
                    b.mNumber, b.mContentIntent, b.mFullScreenIntent, b.mLargeIcon,
                    b.mActionInfos);
        }
    ...
    public static class Builder {
        ...
        int mNumber;
        final List<NotificationActionInfo> mActionInfos = new ArrayList<NotificationActionInfo>();
        ...
        public Builder addAction(int icon, CharSequence title, PendingIntent intent) {
            mActionInfos.add(new NotificationActionInfo(icon, title, intent));
            return this;
        }
        ...
        public Notification getNotification() {
            return IMPL.getNotification(this);
        }
    }
}
